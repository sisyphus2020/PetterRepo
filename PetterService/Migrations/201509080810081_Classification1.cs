namespace PetterService.Migrations
{
    ...
    public partial class Classification1 : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("dbo.BeautyShops", "Grade", c => c.Double(nullable: false));
            AlterColumn("dbo.Companies", "Grade", c => c.Double(nullable: false));
            AlterColumn("dbo.Pensions", "Grade", c => c.Double(nullable: false));
            AlterColumn("dbo.PetSitters", "Grade", c => c.Double(nullable: false));
