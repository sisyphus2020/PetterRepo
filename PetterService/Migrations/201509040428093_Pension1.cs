namespace PetterService.Migrations
{
    ...
    public partial class Pension1 : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("dbo.BeautyShops", "FileName", c => c.String(maxLength: 100));
            AlterColumn("dbo.BeautyShops", "FilePath", c => c.String(maxLength: 100));
            ...
            AlterColumn("dbo.Pensions", "FileName", c => c.String(maxLength: 100));
            AlterColumn("dbo.Pensions", "FilePath", c => c.String(maxLength: 100));
            ...
            AlterColumn("dbo.PetSitters", "FileName", c => c.String(maxLength: 100));
            AlterColumn("dbo.PetSitters", "FilePath", c => c.String(maxLength: 100));
        ...
        public override void Down()
        {
            ...
            AlterColumn("dbo.PetSitters", "FilePath", c => c.String());
            AlterColumn("dbo.PetSitters", "FileName", c => c.String());
            ...
            AlterColumn("dbo.Pensions", "FilePath", c => c.String());
            AlterColumn("dbo.Pensions", "FileName", c => c.String());
            AlterColumn("dbo.Pensions", "PensionAddr", c => c.String());
            AlterColumn("dbo.Pensions", "PensionName", c => c.String());
            AlterColumn("dbo.Members", "FilePath", c => c.String());
            AlterColumn("dbo.Members", "FileName", c => c.String());
            ...
            AlterColumn("dbo.BeautyShops", "FilePath", c => c.String());
            AlterColumn("dbo.BeautyShops", "FileName", c => c.String());
